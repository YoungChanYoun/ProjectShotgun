...
<!-- END of JavaScript to make Hidden Side Menu Work -->
	...
	<div class="container">
		<div class="header">
         <a href="./studentHomePage2.php" id="logo"><img src="images/logo.png" alt="Ingenious logo" style="width:250px;"></a>
		...
		<div class="contents">
			<div class="content">
				...
				<div class="testEachCourse">
                    ...
                    <img id='welcome_bg' src='./images/studentwelcome.png' style='width:100%; height:80%;margin: 5% 5%;'>
